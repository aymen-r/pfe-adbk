        ...
        <TableBody>
          {data.map((r) => (
            <TableRow key={r._id}>
              ...
              <button className="btn btn-primary mx-2 rounded-circle" onClick={() => window.location.href = `/clients/view/${r._id}`}>
              <i class="bi bi-eye-fill"></i>
                </button>
                <button className="btn btn-primary mx-2 rounded-circle" onClick={() => window.location.href = `/clients/edit/${r._id}`}>
